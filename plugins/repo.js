...
async (conn, mek, m, { from, reply }) => {
    const githubRepoURL = 'https://github.com/voldigo-anos/VOLDI-MD';
...
└──────────────────────┘
> *MADE IN BY VOLDI NY HADÈS²¹*`;

        await conn.sendMessage(from, {
            image: { url: `https://files.catbox.moe/817152.jpg` },
            caption: message,
            contextInfo: { 
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: config.OWNER_NAME || 'VOLDI NY HADÈS²¹',
                    serverMessageId: 143
                }
            }
        }, { quoted: mek });
